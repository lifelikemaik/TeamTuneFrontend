...
function TermsAndConditions(props) {
    return (
        <div>
            ...
            <p>
                By accessing this Website, accessible from http://teamtune.fun,
            ...
            <p>
                ...
                materials on teamtune.fun's Website for personal, non-commercial
            ...
            <p>
                This will let teamtune.fun to terminate upon violations of any
            ...
            <p>
                All the materials on teamtune.fun’s Website are provided "as
                is". teamtune.fun makes no warranties, may it be expressed or
                implied, therefore negates all other warranties. Furthermore,
                teamtune.fun does not make any representations concerning the
            ...
            <p>
                teamtune.fun or its suppliers will not be hold accountable for
                any damages that will arise with the use or inability to use the
                materials on teamtune.fun’s Website, even if teamtune.fun or an
            ...
            <p>
                The materials appearing on teamtune.fun’s Website may include
                technical, typographical, or photographic errors. teamtune.fun
                will not promise that any of the materials in this Website are
                accurate, complete, or current. teamtune.fun may change the
                materials contained on its Website at any time without notice.
                teamtune.fun does not make any commitment to update the
                materials.
            </p>
            ...
            <p>
                teamtune.fun has not reviewed all of the sites linked to its
                Website and is not responsible for the contents of any such
                linked site. The presence of any link does not imply endorsement
                by teamtune.fun of the site. The use of any linked website is at
                the user’s own risk.
            </p>
            ...
            <p>
                teamtune.fun may revise these Terms of Use for its Website at
            ...
            <p>
                Any claim related to teamtune.fun's Website shall be governed by
