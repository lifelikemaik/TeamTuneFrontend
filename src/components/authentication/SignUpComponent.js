...
function SignUpComponent(props) {
    ...
    const onOpenSpotify = (props) => {
        if (!isLinkedToSpotify) {
            ...
            window.open("https://accounts.spotify.com/authorize?client_id=13fc26a1aa724752953370044913e510&response_type=code&redirect_uri=https://backend.teamtune.fun/callback/register&scope=user-read-private%20user-read-email%20user-library-read%20user-library-modify%20playlist-read-collaborative%20playlist-read-private%20playlist-modify-private%20playlist-modify-public%20streaming%20user-read-currently-playing%20user-read-playback-state&state=" + generateRandomString(16), "_self");
        }
    }
