...
import {addPlaylist, getPlaylist} from "../redux/actions";
...
function PlaylistDetailsView(props) {
    ...
    return (!selectedPlaylist || (!selectedPlaylist?.playlist && !selectedPlaylist?.error && !newPlaylist)) ? (
        <Loading/>
...
export default connect(null, {getPlaylist, addPlaylist})(
    PlaylistDetailsView
);
